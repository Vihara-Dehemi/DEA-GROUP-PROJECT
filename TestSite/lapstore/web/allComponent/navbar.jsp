...
<nav class="navbar navbar-expand-lg navbar-dark bg-custom">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="all_msi.jsp"><i class="fa-solid fa-laptop"></i> MSI</a>
            </li>

            <li class="nav-item active">
                <a class="nav-link disabled" href="all_asus.jsp"><i class="fa-solid fa-laptop"></i> ASUS</a>
            </li>
            <li class="nav-item active">
                <a class="nav-link disabled" href="all_dell.jsp"><i class="fa-solid fa-laptop"></i> DEL</a>
            </li>
        </ul>
        <form class="form-inline my-2 my-lg-0">
