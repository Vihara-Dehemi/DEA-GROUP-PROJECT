 ...
 */
@MultipartConfig
@WebServlet(name = "LapAdd", urlPatterns = {"/LapAdd"})
public class LapAdd extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet LapAdd</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet LapAdd at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            LapDtls b=new LapDtls( lapName, price, fileName, category);
            ...
            if(f){
                ...
                response.sendRedirect("admin/addLap.jsp");
            }else{
